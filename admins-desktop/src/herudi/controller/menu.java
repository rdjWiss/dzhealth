...
public class menu implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        w = 0.1;
        h = 0.1;
        listMenu.getItems().addAll("  Praticiens","   Ajouter","   Modifier","   Supprimer","   A Propos","   Quitter");
        Platform.runLater(() -> {
            ...
            con.loadAnchorPane(paneData, "Praticiens.fxml");
    ...
    private void aksiKlikListMenu(MouseEvent event) {
        switch(listMenu.getSelectionModel().getSelectedIndex()){
            ...
            case 1:{
                con.loadAnchorPane(paneData, "Ajouter.fxml");
            }break;
            case 2:{
                 con.loadAnchorPane(paneData, "Modifier.fxml");
            }break;
            case 3:{
                 con.loadAnchorPane(paneData, "Supprimer.fxml");
            }break;
